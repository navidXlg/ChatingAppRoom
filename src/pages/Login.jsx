...
import GhostLayout from '../Componants/GhostLayout';
bouncy.register();
...
export default function Login(){
  ...
  const {user, handelLoginSubmit, loadingRequest, logInError} = useAuth();
  ...
  const handelSubmit = (event) => {
    setCredintal({});
    handelLoginSubmit(event, credintial)
  };
