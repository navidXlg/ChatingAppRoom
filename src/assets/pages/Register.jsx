...
export default function Register(){
  ...
  const {user, userRegister, loadingRequest, registerError, model, setModel} = useAuth();
  ...
  return (
    ...
    <section className = "min-h-screen relative flex items-stretch text-white ">
        ...
        <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center">
            ...
            <div className="bottom-6 absolute p-4 text-center right-0 left-0 flex justify-center space-x-4">
                <span>
            ...
            <div className="w-full py-2 z-20">
                ...
                onSubmit={(event) => {userRegister(event, credintial)}}>
                    ...
                    <div className="px-4 pb-2 pt-4">
                        ...
                        <div className='mt-5 text-orange-600 font-bold flex items-center gap-1'>
                            {registerError || ""}
                        </div>
                    </div>
